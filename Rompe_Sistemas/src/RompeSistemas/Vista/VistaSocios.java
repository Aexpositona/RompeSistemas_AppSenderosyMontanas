...
public class VistaSocios<A, B, C> {

    // Atributos
    private A vAñadirSocio;
    private B vVistaModificarSeguro;
    private C vVistaListarSocios;
     ...
     */
    public VistaSocios(A vAñadirSocio, B vVistaModificarSeguro, C vVistaListarSocios) {
